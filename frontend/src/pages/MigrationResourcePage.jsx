...
import { getMigrationResourceBySlug } from '../data/migrationResources'

export default function MigrationResourcePage() {
  const { slug } = useParams()
  const resource = getMigrationResourceBySlug(slug)
